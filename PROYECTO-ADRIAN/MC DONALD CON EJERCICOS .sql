...
--create user MC_DONALD identified by MC_DONALD;
--GRANT CONNECT, RESOURCE, DBA TO MC_DONALD;
...
/* 
 * EL CLIENTE CARLOS RUIZ SE HA EQUIVOCADO Y SU NUMERO DE TELEFONO ES 666666666
 * 
 * EL PRODUCTO CON ID 100 HA SUBIDO SUS PRECIOS A 15.50
 * 
 * 
 * ANA TORRES VIVE EN LA CALLE MATALLANA 10 
 * 
 * Registrar un nuevo producto con ID 504, nombre “Tomate Frito”, precio 1.30 y stock 60 unidades.
 * 
 * 
 * Añadir una nueva receta con código 103, sin alérgenos y de tipo “Ensalada”.
 * 
 * Cambiar la zona de la reserva con código 2 a “Terraza Cubierta”.
 * 
 */
